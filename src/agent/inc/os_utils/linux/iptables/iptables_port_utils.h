...
#ifndef IPTABLES_PORT_UTILS_H
#define IPTABLES_PORT_UTILS_H
...
/**
 * @brief A generic get port which gets the ports of this rule (the type of the ip - src\dest is determined by the given flag).
 * 
 ...
 */
MOCKABLE_FUNCTION(, IptablesResults, IptablesPortUtils_GetPort, const struct ipt_entry*, entry,  bool, isSrcIp, char*, buffer, uint32_t, bufferSize);

#endif //IPTABLES_PORT_UTILS_H