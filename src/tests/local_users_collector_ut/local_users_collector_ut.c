...
TEST_FUNCTION(LocalUsersCollector_GetEvents_ExpectSuccess)
{
    ...
    STRICT_EXPECTED_CALL(UsersIterator_GetUserId(IGNORED_PTR_ARG)).SetReturn(5);
    STRICT_EXPECTED_CALL(JsonObjectWriter_WriteInt(IGNORED_PTR_ARG, LOCAL_USERS_USER_ID_KEY, 5)).SetReturn(JSON_WRITER_OK);
